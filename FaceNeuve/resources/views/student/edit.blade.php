            ...
            <div class="row align-items-stretch mb-5">
                <div class="col-md-6 mx-auto d-flex flex-column gap-3">
                    <div class="form-group">
                        ...
                        <input class="form-control" id="firstname" name="firstname" type="text" placeholder="Ton Prenom" value="{{ old('firstname', $student->firstname) }}" />
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="name" name="name" type="text" placeholder="Ton nom *" value="{{ old('name', $student->name) }}" />
                        @if($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" id="email" type="email" name="email" placeholder="Ton courriel *" value="{{ old('email', $student->email) }}" />
                        @if($errors->has('email'))
                    ...
                    <div class="form-group mb-md-0">
                        ...
                        <input class="form-control" id="phone" type="tel" name="phone" placeholder="Format: XXXXXXXXXX" value="{{ old('phone', $student->phone) }}" />
                        @if($errors->has('phone'))
                    ...
                    <div class="form-group mb-md-0">
                        ...
                        <input class="form-control" id="birthday" type="date" name="birthday" placeholder="Ton anniversaire *" value="{{ old('birthday', $student->birthday) }}" />
