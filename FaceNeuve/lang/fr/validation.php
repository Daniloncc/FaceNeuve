...
return [
    ...
    | versions comme les règles de taille. N'hésitez pas à ajuster chacun de
    | ces messages ici.
    |
    */
    ...
    */
    ...
    | placeholder d'attribut par quelque chose de plus convivial comme
    | "Adresse e-mail" au lieu de "email". Cela nous aide simplement à
    | rendre nos messages plus expressifs.
    |
    */
